...
void setup()
{
  ...
  if(barometer.IsConnected())
  {
    ...
    barometer.SetResolution(BMP180_MODE_ULTRA_LOW_POWER );
    barometer.SetSeaLevelPressure( 101325 ) ;
    // my altitude is 124.184 Meters
    // if you know your altitude replace 125.184 with your altitude
    barometer.SetSeaLevelPressure( BMP180_METERS, 125.184 ) ;
}
  else
  { 
...
void loop()
{
  if(barometer.IsConnected())
  {
    ...
    float altitude = barometer.GetAltitude(BMP180_METERS );
    ...
    float currentTemperature = barometer.GetTemperature(BMP180_CENTIGRADE);
